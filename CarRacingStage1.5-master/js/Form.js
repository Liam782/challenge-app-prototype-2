class Form {
  ...
  display(){
    ...
    logo = createSprite(displayWidth/2 - 50, 340);
    logo.addImage("LOGO",logoImg);
    logo.scale = 0.5;
    
    this.username.position(displayWidth/2 - 50, 235);
    this.letsGoButton.position(displayWidth/2, 285);
    ...
    //this.reset.position(displayWidth/2 - 100,20);
        ...
        this.letsGoButton.mousePressed(()=>{
          ...
          this.greeting.position(displayWidth/2 - 50, 150);


          this.competeButton.position(displayWidth/2,305);

          

          this.sportName.position(displayWidth/2, 210);
          this.time.position(displayWidth/2,245);
          this.time.option(30);
          this.time.option(60);
          this.time.option(90);
         ...
         this.intensity.position(displayWidth/2 ,275);
